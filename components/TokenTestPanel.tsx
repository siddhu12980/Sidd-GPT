            ...
            <>
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <div>
                    Within Limits:{" "}
                    {testResult.tokenCheck.withinLimits ? "✅" : "❌"}
                  </div>
                  <div>
                    Input Tokens:{" "}
                    {testResult.tokenCheck.inputTokens.toLocaleString()}
                  </div>
                  <div>
                    Max Input:{" "}
                    {testResult.tokenCheck.maxInputTokens.toLocaleString()}
                  </div>
                  <div>
                    Total Estimated:{" "}
                    {testResult.tokenCheck.totalEstimated.toLocaleString()}
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div>
                    Utilization:{" "}
                    {testResult.usageSummary.utilizationPercentage.toFixed(1)}%
                  </div>
                  <div>
                    Estimated Cost: $
                    {testResult.usageSummary.estimatedCost.toFixed(4)}
                  </div>
                </div>
              </div>
